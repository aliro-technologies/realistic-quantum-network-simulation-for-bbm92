...
SOURCE_BANDWIDTH_FWHM = 3e-9 # Source bandwidth FWHM, in meters
...
DETECTOR_MAXIMUM_EFFICIENCY = 0.6
...
if __name__ == "__main__":
    ...
    for link_loss in losses:

        # Make dict with parameters
        simulation_parameters = {
            "channel_length": CHANNEL_LENGTH,
            "channel_delay": CHANNEL_DELAY,
            "link_loss_in_db_a": link_loss,
            "link_loss_in_db_b": link_loss,
    ...
    del simulation_results["link_loss_in_db_a"]
    del simulation_results["link_loss_in_db_b"]
