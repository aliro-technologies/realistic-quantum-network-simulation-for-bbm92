...
To create Figures 2 and 3 from the theory, Aliro Simulator, and experimental analysis files, run the bash script `run_make_comparison_plot.sh`. When this script is run, the reference images in `comparison_results` directory will be overwritten.
