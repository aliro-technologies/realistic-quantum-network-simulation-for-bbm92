...
if __name__ == "__main__":
    ...
    file_name_string = datetime.utcnow().strftime("%H_%M_%S") + "_visibility"
    file_path = dir_path + "/" + file_name_string

    visibilities = np.linspace(0.80, 1.0, 1000)
    ...
    for visibility in visibilities:
        ...
        simulation_parameters = {
            ...
            "probability_optical_error": probability_optical_error,
    ...
    del simulation_results["probability_optical_error"]
    simulation_results["data_type"] = "numerics"
    simulation_results["visibility"] = list(visibilities)
    ...
    simulation_results["x_parameter_name"] = "visibility"
